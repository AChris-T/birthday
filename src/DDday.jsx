    ...
    <div className="flex flex-col items-center justify-center w-full">
        <div className="flex flex-wrap items-center gap-10 px-5 mt-10 mb-10 lg:justify-center md:justify-start ">
            <div className="flex flex-col ">
                <h3 className="text-[#3869fd] font-extrabold">Contact Info</h3>
                <div className="flex flex-col gap-4">
                <div className="flex items-center gap-2 ">
                <CiCalendar className="w-[20px] h-10 text-[#93935b] " />
                <h3 className="text-[15px] text-gray-500 font-bold"> 31sth August, 2024</h3>
                </div>
                <div className="flex  items-center gap-2 mt-[-10px]">
                <MdAccessTime className="w-[20px] h-10 text-[#93935b] " />
                <h3 className="text-[15px] text-gray-500 font-bold">3pm (No Africa time)</h3>
                </div>
                <div className="flex  items-center gap-2 mt-[-10px]">
                <CiLocationOn className="w-[20px] h-10 text-[#93935b] " />
            ...
            <div className="flex flex-col gap-3">
               <h3 className="text-[#3869fd] font-extrabold"> Party Celebration</h3>
               <div className="flex flex-col gap-4">
                <div className="flex items-center gap-2 ">
                <CiCalendar className="w-[20px] h-10 text-[#93935b] " />
            ...
            <div className="flex flex-col gap-3 ">
            <h3 className="text-[#3869fd] font-extrabold"> Thanksgiving Service</h3>
            <div className="flex flex-col gap-4">
                <div className="flex items-center gap-2 ">
                <CiCalendar className="w-[20px] h-10 text-[#93935b] " />
                ...
                <p className="flex mb-8 text-center">Please confirm your attendance by clicking this button.</p>
